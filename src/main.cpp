...
void printUsage(const char* programName) {
    ...
    std::cout << "  " << programName << " -v 10 -h 4.5 -c 8 -t 0.5     # All args: 10 vehicles, 4.5 hours, 8 chargers, 0.5s timestep\n";
}
...
int main(int argc, char* argv[]) {
    ...
    Simulation simulation(numVehicles, simHours, numChargers, simTimeStepSeconds);
